/* Generated by Cython 0.17 on Tue Nov 12 21:27:35 2013 */
...
static char __pyx_k_15[] = "/Users/tomevans/code/py/planetc_dev/planetc/ma02.pyx";
static char __pyx_k_16[] = "planetc.ma02";
...
static PyObject *__pyx_n_s__F_nonlin;
static PyObject *__pyx_n_s__F_quad;
static PyObject *__pyx_n_s__NormSep;
static PyObject *__pyx_n_s__RpRs;
...
static PyMethodDef __pyx_mdef_7planetc_4ma02_1F_quad = {__Pyx_NAMESTR("F_quad"), (PyCFunction)__pyx_pw_7planetc_4ma02_1F_quad, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_7planetc_4ma02_F_quad)};
static PyObject *__pyx_pw_7planetc_4ma02_1F_quad(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__NormSep,&__pyx_n_s__RpRs,&__pyx_n_s__gam1,&__pyx_n_s__gam2,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__NormSep)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__RpRs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("F_quad", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__gam1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("F_quad", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__gam2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("F_quad", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "F_quad") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_RpRs = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_RpRs == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_gam1 = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_gam1 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_gam2 = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_gam2 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("F_quad", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("planetc.ma02.F_quad", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_NormSep), __pyx_ptype_5numpy_ndarray, 1, "NormSep", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_7planetc_4ma02_F_quad(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_NormSep, double __pyx_v_RpRs, double __pyx_v_gam1, double __pyx_v_gam2) {
  ...
  __pyx_pybuffernd_NormSep.rcbuffer = &__pyx_pybuffer_NormSep;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_NormSep.rcbuffer->pybuffer, (PyObject*)__pyx_v_NormSep, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  __pyx_t_1 = PyLong_FromUnsignedLong(__pyx_v_n); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_5 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__double); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_5 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
...
static PyMethodDef __pyx_mdef_7planetc_4ma02_3F_nonlin = {__Pyx_NAMESTR("F_nonlin"), (PyCFunction)__pyx_pw_7planetc_4ma02_3F_nonlin, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_7planetc_4ma02_2F_nonlin)};
static PyObject *__pyx_pw_7planetc_4ma02_3F_nonlin(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__NormSep,&__pyx_n_s__RpRs,&__pyx_n_s__c1,&__pyx_n_s__c2,&__pyx_n_s__c3,&__pyx_n_s__c4,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__RpRs)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("F_nonlin", 1, 6, 6, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__c1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("F_nonlin", 1, 6, 6, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__c2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("F_nonlin", 1, 6, 6, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__c3)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("F_nonlin", 1, 6, 6, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__c4)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("F_nonlin", 1, 6, 6, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "F_nonlin") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_NormSep = ((PyArrayObject *)values[0]);
    __pyx_v_RpRs = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_RpRs == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_c1 = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_c1 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_c2 = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_c2 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_c3 = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_c3 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_c4 = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_c4 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("F_nonlin", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("planetc.ma02.F_nonlin", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_NormSep), __pyx_ptype_5numpy_ndarray, 1, "NormSep", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_7planetc_4ma02_2F_nonlin(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_NormSep, double __pyx_v_RpRs, double __pyx_v_c1, double __pyx_v_c2, double __pyx_v_c3, double __pyx_v_c4) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_NormSep.rcbuffer->pybuffer, (PyObject*)__pyx_v_NormSep, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_NormSep.diminfo[0].strides = __pyx_pybuffernd_NormSep.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_NormSep.diminfo[0].shape = __pyx_pybuffernd_NormSep.rcbuffer->pybuffer.shape[0];
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyLong_FromUnsignedLong(__pyx_v_n); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__double); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__F_nonlin, __pyx_k__F_nonlin, sizeof(__pyx_k__F_nonlin), 0, 0, 1, 1},
  {&__pyx_n_s__F_quad, __pyx_k__F_quad, sizeof(__pyx_k__F_quad), 0, 0, 1, 1},
  {&__pyx_n_s__NormSep, __pyx_k__NormSep, sizeof(__pyx_k__NormSep), 0, 0, 1, 1},
  {&__pyx_n_s__RpRs, __pyx_k__RpRs, sizeof(__pyx_k__RpRs), 0, 0, 1, 1},
  ...
  {&__pyx_n_s__c4, __pyx_k__c4, sizeof(__pyx_k__c4), 0, 0, 1, 1},
  ...
  {&__pyx_n_s__gam2, __pyx_k__gam2, sizeof(__pyx_k__gam2), 0, 0, 1, 1},
 ...
 *     """
 */
  __pyx_k_tuple_13 = PyTuple_New(7); if (unlikely(!__pyx_k_tuple_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_13);
  __Pyx_INCREF(((PyObject *)__pyx_n_s__NormSep));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 0, ((PyObject *)__pyx_n_s__NormSep));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__NormSep));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__RpRs));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 1, ((PyObject *)__pyx_n_s__RpRs));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__RpRs));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__gam1));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 2, ((PyObject *)__pyx_n_s__gam1));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__gam1));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__gam2));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 3, ((PyObject *)__pyx_n_s__gam2));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__gam2));
 ...
 *     """
 */
  __pyx_k_tuple_17 = PyTuple_New(9); if (unlikely(!__pyx_k_tuple_17)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_17);
  __Pyx_INCREF(((PyObject *)__pyx_n_s__NormSep));
  PyTuple_SET_ITEM(__pyx_k_tuple_17, 0, ((PyObject *)__pyx_n_s__NormSep));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__NormSep));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__RpRs));
  PyTuple_SET_ITEM(__pyx_k_tuple_17, 1, ((PyObject *)__pyx_n_s__RpRs));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__RpRs));
  ...
  PyTuple_SET_ITEM(__pyx_k_tuple_17, 3, ((PyObject *)__pyx_n_s__c2));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__c2));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__c3));
  PyTuple_SET_ITEM(__pyx_k_tuple_17, 4, ((PyObject *)__pyx_n_s__c3));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__c3));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__c4));
  PyTuple_SET_ITEM(__pyx_k_tuple_17, 5, ((PyObject *)__pyx_n_s__c4));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__c4));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__i));
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("ma02"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
 ...
 *     """
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7planetc_4ma02_1F_quad, NULL, __pyx_n_s_16); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__F_quad, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     """
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7planetc_4ma02_3F_nonlin, NULL, __pyx_n_s_16); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__F_nonlin, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
